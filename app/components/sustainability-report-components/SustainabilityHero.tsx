      ...
      <div className='relative z-10 flex h-full items-center justify-center px-4'>
        <div className='mx-auto w-full max-w-6xl text-left'>
          ...
          <p className='mt-6 text-base text-gray-200 md:text-[20px] max-w-3xl'>
            Pendekatan komprehensif dalam penyusunan laporan keberlanjutan untuk menyajikan kinerja perusahaan dalam aspek lingkungan, sosial, dan tata kelola (ESG) secara jelas dan terstruktur. Kami tidak hanya memastikan keakuratan data, tetapi juga mengemas narasi yang mencerminkan komitmen, dampak, dan strategi keberlanjutan perusahaan.
          </p>
